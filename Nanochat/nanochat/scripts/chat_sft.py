...
If ~/.cache/nanochat/base_checkpoints is empty, train a tiny base run (writes d12), or pull from Hub:

  bash runs/quick_base_checkpoint.sh   # few steps; good for local smoke tests
  python -m scripts.chat_sft
